// src/components/GaussSeidel.js

import React, { useState } from 'react';
import axios from 'axios';
import './GaussSeidel.css'; // Asegúrate de crear este archivo CSS
...
function GaussSeidel() {
  ...
  const fetchAPI = async (A, b, x0, tolerancia, max_iter) => {
    const matrixA = convertMatrixToString(A);
    const vectorB = convertVectorToString(b);
  ...
  return (
    <div className="gauss-seidel">
      <h1>Método Gauss-Seidel</h1>
      <div className='card'>
